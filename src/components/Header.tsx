...
import { Search, Eye, EyeOff, LayoutGrid, Map as MapIcon } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="w-full bg-white border-b border-slate-200 sticky top-0 z-30 px-4 md:px-8 py-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <input
                ...
                className="text-lg font-bold text-slate-900 bg-transparent border-b border-transparent hover:border-slate-300 focus:border-[#125977] px-1 py-0.5 rounded transition-all focus:outline-none"
